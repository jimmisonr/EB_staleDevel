...
class EventbookingViewFieldHtml extends RADViewItem
{
	...
	function display()
	{
		...
		if ($config->custom_field_by_category)
		{
			...
			$this->lists['category_id'] = JHtml::_('select.genericlist', $options, 'category_id', 
				array(
					...
					'option.text' => 'text', 
					'option.value' => 'value', 
					'list.attr' => ' class="input-xlarge chosen" ',
		...
		else
		{
			...
			$this->lists['event_id'] = JHtml::_('select.genericlist', $options, 'event_id[]', 'class="input-xlarge chosen" multiple="multiple" size="5" ', 'id',
				'title', $selecteds);
		}
