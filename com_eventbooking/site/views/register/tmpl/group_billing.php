...
<?php 									
	...
	<?php	
		...
		if ($this->enableCoupon || $this->discountAmount > 0 || ($this->config->enable_tax && $this->config->tax_rate > 0))
		{
		?>
		<div class="control-group">
			<label class="control-label">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="input-medium" name="coupon_code" id="coupon_code" value="<?php echo JRequest::getVar('coupon_code'); ?>" onchange="validateGroupRegistrationCoupon();" />
