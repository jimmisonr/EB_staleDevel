...
$headerText = JText::_('EB_REGISTRATION_PAYMENT');
...
{
	$msg = JText::_('EB_REGISTRATION_PAYMENT_MESSAGE');
}
...
<div id="eb-deposit-payment-page" class="eb-container">
	...
	<form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_eventbooking&task=payment.process_registration_payment&Itemid='.$this->Itemid, false, (int) $this->config->use_https); ?>" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
	<?php
	if (strlen($msg))
	{
	?>
